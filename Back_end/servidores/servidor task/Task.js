    ...
    if (req.method === 'GET') {
        ...
        if ( message?.type === 'text' || message?.type === 'audio' || message?.type === 'image' || message?.type === 'video' || message?.type === 'document'){
            ...
            if (phone_number) {
                ...
                const url = 'https://us-central1-frangoboss.cloudfunctions.net/IA_whatszapp_tasks';
                const serviceAccountEmail = '909553356548-compute@developer.gserviceaccount.com';
